...
import { Smartphone, BookOpen, Download, Sparkles } from 'lucide-react';
  ...
  return (
    <section className="py-32 px-6 md:px-12 text-center relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          QuantaLLM will let you run quantized, state-of-the-art language models right on your Android phone completely offline, completely private.
        </motion.p>
